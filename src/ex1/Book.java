...
class Book {
	 ...
	 */
	public Book(String title, String author, int yearOfPublication, int comicValue, int dramaticValue,
			int educationalValue) {
		this.title = title;
		this.author = author;
	 ...
	 * titled "Monkey Feet", was written by Ernie Douglas, published in 1987 and has
	 * a comic value of 7, dramatic value of 3 and an educational value of 1, this
	 * method will return the string: "[MonkeyFeet,Ernie Douglas,1987,11]"
	 * 
	...
	/**
	 * @return the literary value of this book, which is defined as the sum of its
	 *         comic value, its dramatic value and its educational value.
	 */
	...
	/**
	 * Sets the given id as the id of the current borrower of this book, -1 if no
	 * patron is currently borrowing it.
	 * 
	 * @param borrowerId
	 */
